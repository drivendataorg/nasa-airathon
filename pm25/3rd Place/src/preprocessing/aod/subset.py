...
This example code illustrates how to access, subset, and visualize an 
LP DAAC MCD19A2 v6 HDF-EOS2 Sinusoidal Grid file in Python.
...
Usage:  save this script and run
    ...
    $python MCD19A2.A2010010.h25v06.006.2018047103710.hdf.s.py
